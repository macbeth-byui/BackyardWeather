...
import macbeth.backyardweather.view.ChartFragment;


public class ChartFragmentPresenter implements FirebaseLoginListener {
    ...
    public ChartFragmentPresenter(ChartFragment fragment) {
    ...
    private void registerForWeatherData() {
        ...
        firebaseListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                Log.d("BackyardWeather", "ChartPresenter registerForWeatherData onChildAdded "+dataSnapshot);
            ...
            public void onChildRemoved(@NonNull DataSnapshot dataSnapshot) {
                Log.d("BackyardWeather", "ChartPresenter registerForWeatherData onChildRemoved "+dataSnapshot);
                WeatherObservation weatherObservation = dataSnapshot.getValue(WeatherObservation.class);
